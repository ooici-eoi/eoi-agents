...
public interface IObservationGroup {
    ...
    /**
     * Adds a scalar variable to the observation group.  This type of variable has a single value that does not vary with any dimension.
     * @param dataAttribs the VariableParams describing the variable
    ...
    /**
     * Gets the data value for the variable indicated by the given VariableParams
     *
     * @param dataAttribs the VariableParams for which to get data
     * @return the scalar data for the params; if no matching params, Float.NaN
     */
    Number getScalarData(VariableParams dataAttribs);

    /**
     * Gets the data value for the variable indicated by the given VariableParams
     *
     * @param dataAttribs the VariableParams for which to get data
     * @return the scalar data for the params; if no matching params, <code>missingVal</code>
     */
    Number getScalarData(VariableParams dataAttribs, Number missingVal);

    /**
     * Gets the data value for the variable indicated by the given VariableParams at the given time and depth
     *
     ...
     *
     * @return If a data value exists for the parameters given, that data is returned; otherwise Float.NaN
     */
    Number getData(VariableParams dataAttribs, Number time, Number depth);

    /**
     * Gets the data value for the variable indicated by the given VariableParams at the given time and depth or returns <code>missingVal</code>
    ...
    /**
     * @return a list of all unique VariableParams values for the observations in this IObservationGroup.  This list
